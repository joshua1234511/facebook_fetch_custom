...
class GraphObjectFactory extends GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = '\drupal\facebook_fetch_custom\GraphNodes\GraphObject';

    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = '\drupal\facebook_fetch_custom\GraphNodes\GraphList';
