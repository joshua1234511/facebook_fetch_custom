 ...
 *
 */
namespace drupal\facebook_fetch_custom\GraphNodes;
...
class GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = '\drupal\facebook_fetch_custom\GraphNodes\GraphNode';

    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = '\drupal\facebook_fetch_custom\GraphNodes\GraphEdge';

    /**
     * @const string The graph object prefix.
     */
    const BASE_GRAPH_OBJECT_PREFIX = '\drupal\facebook_fetch_custom\GraphNodes\\';
