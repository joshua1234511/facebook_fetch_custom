 ...
 *
 */
namespace drupal\facebook_fetch_custom\Facebook;

use drupal\facebook_fetch_custom\Authentication\AccessToken;
use drupal\facebook_fetch_custom\Authentication\OAuth2Client;
use drupal\facebook_fetch_custom\FileUpload\FacebookFile;
use drupal\facebook_fetch_custom\FileUpload\FacebookResumableUploader;
use drupal\facebook_fetch_custom\FileUpload\FacebookTransferChunk;
use drupal\facebook_fetch_custom\FileUpload\FacebookVideo;
use drupal\facebook_fetch_custom\GraphNodes\GraphEdge;
use drupal\facebook_fetch_custom\Url\UrlDetectionInterface;
use drupal\facebook_fetch_custom\Url\FacebookUrlDetectionHandler;
use drupal\facebook_fetch_custom\PseudoRandomString\PseudoRandomStringGeneratorFactory;
use drupal\facebook_fetch_custom\PseudoRandomString\PseudoRandomStringGeneratorInterface;
use drupal\facebook_fetch_custom\HttpClients\HttpClientsFactory;
use drupal\facebook_fetch_custom\PersistentData\PersistentDataFactory;
use drupal\facebook_fetch_custom\PersistentData\PersistentDataInterface;
use drupal\facebook_fetch_custom\Helpers\FacebookCanvasHelper;
use drupal\facebook_fetch_custom\Helpers\FacebookJavaScriptHelper;
use drupal\facebook_fetch_custom\Helpers\FacebookPageTabHelper;
use drupal\facebook_fetch_custom\Helpers\FacebookRedirectLoginHelper;
use drupal\facebook_fetch_custom\Exceptions\FacebookSDKException;
...
class Facebook
{
    ...
    public function setDefaultAccessToken($accessToken)
    {
        ...
        throw new \InvalidArgumentException('The default access token must be of type "string" or drupal\facebook_fetch_custom\AccessToken');
    }
