...
use drupal\facebook_fetch_custom\HttpClients\FacebookHttpClientInterface;
use drupal\facebook_fetch_custom\HttpClients\FacebookCurlHttpClient;
use drupal\facebook_fetch_custom\HttpClients\FacebookStreamHttpClient;
...
class FacebookClient
{
    ...
    {
        if (get_class($request) === 'drupal\facebook_fetch_custom\FacebookRequest') {
