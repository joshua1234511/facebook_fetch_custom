 ...
 *
 */
namespace drupal\facebook_fetch_custom\HttpClients;
...
class HttpClientsFactory
{
     ...
     * @throws InvalidArgumentException If the http client handler isn't "curl", "stream", "guzzle", or an instance of drupal\facebook_fetch_custom\HttpClients\FacebookHttpClientInterface.
     *
    ...
    public static function createHttpClient($handler)
    {
        ...
        throw new InvalidArgumentException('The http client handler must be set to "curl", "stream", "guzzle", be an instance of GuzzleHttp\Client or an instance of drupal\facebook_fetch_custom\HttpClients\FacebookHttpClientInterface');
    }
